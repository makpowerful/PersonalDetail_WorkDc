...
public class Set1B_Question3 extends TestBase{
	...
	{
		Set1B_Question3PageObject qp=new Set1B_Question3PageObject();
		checkPageReady();
		...
		d.findElement(qp.getSearchField()).sendKeys("Kotak Mahindra Bank Ltd.");
		Thread.sleep(2000);
		...
		Assert.assertEquals(newWinTitle.contains("KOTAK MAHINDRA BANK LTD."),true);
