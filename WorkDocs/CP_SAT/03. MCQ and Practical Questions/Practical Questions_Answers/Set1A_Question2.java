...
public class Set1A_Question2 extends TestBase{
	...
	public void Test1() throws Exception {
		...
		for (int i = 0; i < 4; i++) {
			checkMenu(readData("src\\test\\resources\\TestData\\TestData1.xlsx", "Question2", i, 0));
			checkSubMenu(readData("src\\test\\resources\\TestData\\TestData1.xlsx", "Question2", i, 1));
			checkSubMenuLink(readData("src\\test\\resources\\TestData\\TestData1.xlsx", "Question2", i, 1),
					readData("src\\test\\resources\\TestData\\TestData1.xlsx", "Question2", i, 2));
		}
