...
public class Set2B_Question6 extends TestBase {
	...
	public void testMethod() throws Exception {
		...
		String fileName = "src\\test\\resources\\TestData\\TestData_Search.xlsx";
		...
		//Filter the search results from price High to low. 
		d.findElement(By.xpath("//ul[@class='rightpanel-filter']//li[3]")).click();
		
		//Verify the first 8 products are displayed in descending order of price as per filter.
		...
		for(i1 =1; i1<8; )
		{
			...
			{
				System.out.println("Prices for "+searchKey+" not in descending order");
				flag =1;
				break;
			}
		}
		...
		if(flag!=1)
		{
			System.out.println("Prices for "+searchKey+" are in descending order");
		}
