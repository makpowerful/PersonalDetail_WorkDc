...
public class test_LoginScreenUAT extends base {

	public WebDriver driver;
	public static Logger log = LogManager.getLogger(test_LoginScreenUAT.class.getName());
	...
	public void validateloginPage() throws IOException, InterruptedException {
		...
		Thread.sleep(1000);
		//Enter Username and Password to login.
		al = excelData.getData("TC3", "Login", "Sno");
		System.out.println(al.toString());
		ls.EnterUsername(al.get(1).toString());
