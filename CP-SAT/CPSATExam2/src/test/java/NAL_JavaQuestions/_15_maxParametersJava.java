...
public class _15_maxParametersJava {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		// int, short byte, boolean, float, classtype --> 254 (non static) and 255(static)
		// double, long --> 127 (non static) and (static)

	}

	public static void test(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11,
